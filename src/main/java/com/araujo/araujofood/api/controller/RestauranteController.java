...
import com.araujo.araujofood.core.validation.ValidacaoException;
...
public class RestauranteController {
    ...
    public Restaurante alterar(@PathVariable @Valid Long restauranteId, @RequestBody Restaurante restaurante) {
